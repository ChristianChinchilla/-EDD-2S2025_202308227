...
begin
  ...
  // Amarrar eventos por si el diseñador no lo hizo
...
procedure TfrmInbox.gridInboxButtonClick(Sender: TObject; aCol, aRow: Integer);
begin
...
begin
  ...
  begin
    GCorreos.Remove(P);     // helper en uListaCorreos
    FillInbox;
  end;
end;
...
var
  ...
  function CompareCorreo(const A, B: PCorreo): Integer; inline;
  begin
